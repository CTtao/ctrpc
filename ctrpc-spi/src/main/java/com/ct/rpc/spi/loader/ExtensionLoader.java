...
public final class ExtensionLoader<T> {
    ...
    private static final String CT_DIRECTORY = "META-INF/ct/";
    private static final String CT_DIRECTORY_EXTERNAL = "META-INF/ct/external/";
    private static final String CT_DIRECTORY_INTERNAL = "META-INF/ct/internal/";

    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            CT_DIRECTORY,
            CT_DIRECTORY_EXTERNAL,
            CT_DIRECTORY_INTERNAL
    };
    ...
    public Map<String, Class<?>> getExtensionClasses(){
        Map<String, Class<?>> classes = cachesClasses.getValue();
        if (Objects.isNull(classes)){
            synchronized (cachesClasses){
                classes = cachesClasses.getValue();
                if (Objects.isNull(classes)){
                    classes = loadExtensionClass();
                    cachesClasses.setValue(classes);
                }
            }
        }
        return classes;
