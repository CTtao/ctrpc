...
public class RpcSingleServer extends BaseServer {
    ...
    public RpcSingleServer(String serverAddress, String registerAddress, String registerType, String registryLoadBalanceType,String scanPackage, String reflectType) {
