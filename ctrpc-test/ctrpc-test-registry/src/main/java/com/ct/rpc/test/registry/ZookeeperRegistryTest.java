...
public class ZookeeperRegistryTest {
    ...
    public void init() throws Exception{
        ...
        this.serviceMeta = new ServiceMeta(ZookeeperRegistryTest.class.getName(), "1.0.0","ct","127.0.0.1",8080);
    }
    ...
    public void testDiscovery() throws Exception{
        this.registryService.discovery(RegistryService.class.getName(), "ct".hashCode());
    }
